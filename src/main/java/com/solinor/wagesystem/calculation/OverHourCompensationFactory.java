...
public class OverHourCompensationFactory {
    ...
    public static List<OverHourCompensation> makeOverHourCompensations() {
        ...
        overHourCompensations.add(new OverHourCompensation(2, new BigDecimal("0.25")));
        overHourCompensations.add(new OverHourCompensation(2, new BigDecimal("0.50")));
        overHourCompensations.add(new OverHourCompensation(Integer.MAX_VALUE, new BigDecimal("1.00")));
